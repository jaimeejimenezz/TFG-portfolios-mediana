...
if __name__ == "__main__":
    rows = []
    rows.append(("1/N", compute_metrics("data/processed/backtest_equal_weight.csv")))
    rows.append(("Markowitz", compute_metrics("data/processed/backtest_markowitz.csv")))
    ...
    print(pretty)
    pretty.to_csv("data/processed/metrics_baselines.csv")
    print("\nGuardado: data/processed/metrics_baselines.csv")