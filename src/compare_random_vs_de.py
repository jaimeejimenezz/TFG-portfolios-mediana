...
if __name__ == "__main__":
    rows = [
        ...
        (
            "Markowitz CAP10",
            compute_metrics("data/processed/backtest_markowitz_cap10_gross.csv"),
        ),
        (
            "Mediana+MAD Random CAP10",
            compute_metrics("data/processed/backtest_median_mad_random_cap10_gross.csv"),
        ),
        (
            "Mediana+MAD DE CAP10",
            compute_metrics("data/processed/backtest_median_mad_de.csv"),
        ),
    ]
    ...
    print("\n=== Comparativa Random Search vs Differential Evolution ===")
    print(pretty)

    pretty.to_csv("data/processed/metrics_random_vs_de.csv")
    print("\nGuardado: data/processed/metrics_random_vs_de.csv")